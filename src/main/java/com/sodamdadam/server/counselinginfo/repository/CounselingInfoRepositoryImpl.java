...
public class CounselingInfoRepositoryImpl implements CounselingInfoRepository{
    ...
    private PersonalCounselingInfoDto createPersonalCounselingInfo() {
        ...
        return new PersonalCounselingInfoDto(mainText, imgUrl1, imgUrl2, subText1, subText2);
    }

    @Override
    public PersonalCounselingInfoDto getPersonalCounselingInfo() {
